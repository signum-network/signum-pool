...
public class MinerDeadlines extends TableImpl<MinerDeadlinesRecord> {
    ...
    private static final long serialVersionUID = -1634121865;
    ...
    /**
     * The column <code>miner_deadlines.boost</code>.
     */
    public final TableField<MinerDeadlinesRecord, Double> BOOST = createField("boost", org.jooq.impl.SQLDataType.DOUBLE.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.DOUBLE)), this, "");

    /**
     * The column <code>miner_deadlines.boost_pool</code>.
     */
    public final TableField<MinerDeadlinesRecord, Double> BOOST_POOL = createField("boost_pool", org.jooq.impl.SQLDataType.DOUBLE.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.DOUBLE)), this, "");
