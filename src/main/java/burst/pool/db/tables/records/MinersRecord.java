...
public class MinersRecord extends UpdatableRecordImpl<MinersRecord> implements Record10<Long, Long, Long, Double, Double, Long, String, String, Double, Integer> {

    private static final long serialVersionUID = 373843199;
    ...
    /**
     * Setter for <code>miners.share_ratio</code>.
     */
    public void setShareRatio(Double value) {
        set(8, value);
    }

    /**
     * Getter for <code>miners.share_ratio</code>.
     */
    ...
    /**
     * Setter for <code>miners.share_ratio_height</code>.
     */
    public void setShareRatioHeight(Integer value) {
        set(9, value);
    }

    /**
     * Getter for <code>miners.share_ratio_height</code>.
     */
    public Integer getShareRatioHeight() {
     ...
     */
    @Override
    public Row10<Long, Long, Long, Double, Double, Long, String, String, Double, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, Long, Long, Double, Double, Long, String, String, Double, Integer> valuesRow() {
    ...
    public Field<Double> field9() {
        return Miners.MINERS.SHARE_RATIO;
    }
    ...
    public Field<Integer> field10() {
        return Miners.MINERS.SHARE_RATIO_HEIGHT;
    }
     ...
     */
    @Override
    public MinersRecord value9(Double value) {
        setShareRatio(value);
        return this;
    }
     ...
     */
    @Override
    public MinersRecord value10(Integer value) {
        setShareRatioHeight(value);
        return this;
    }
     ...
     */
    @Override
    public MinersRecord values(Long value1, Long value2, Long value3, Double value4, Double value5, Long value6, String value7, String value8, Double value9, Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MinersRecord(Long dbId, Long accountId, Long pendingBalance, Double estimatedCapacity, Double share, Long minimumPayout, String name, String userAgent, Double shareRatio, Integer shareRatioHeight) {
        super(Miners.MINERS);
