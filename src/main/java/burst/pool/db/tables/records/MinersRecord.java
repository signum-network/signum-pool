...
public class MinersRecord extends UpdatableRecordImpl<MinersRecord> implements Record10<Long, Long, Long, Double, Double, Long, String, String, Integer, Double> {

    private static final long serialVersionUID = -487679076;
     ...
     */
    @Override
    public Row10<Long, Long, Long, Double, Double, Long, String, String, Integer, Double> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, Long, Long, Double, Double, Long, String, String, Integer, Double> valuesRow() {
     ...
     */
    @Override
    public MinersRecord values(Long value1, Long value2, Long value3, Double value4, Double value5, Long value6, String value7, String value8, Integer value9, Double value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MinersRecord(Long dbId, Long accountId, Long pendingBalance, Double estimatedCapacity, Double share, Long minimumPayout, String name, String userAgent, Integer sharePercent, Double sharedCapacity) {
        super(Miners.MINERS);
